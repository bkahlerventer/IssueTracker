...
<tr>
<td width="20%" class="label" align="right" valign="top">New Category:</td>
<td width="80%" class="data"><input type="text" size="32" name="category" value="{$smarty.post.category|stripslashes}"></td>
</tr>
