...
if (!empty($_POST['gname'])) {
  ...
  and !ereg("^(0{0,1}[1-9]|1[012])/(0{0,1}[1-9]|[12][0-9]|3[01])/(19|20)[0-9][0-9]$",$_POST['startdate'])) {
    push_error("Invalid start date.");
  }
  if (!empty($_POST['enddate'])
  and !ereg("^(0{0,1}[1-9]|1[012])/(0{0,1}[1-9]|[12][0-9]|3[01])/(19|20)[0-9][0-9]$",$_POST['enddate'])) {
  ...
  if (!errors()) {
    $parts = split("/",$_POST['startdate']);
    $sdate = mktime(0,0,0,$parts[0],$parts[1],$parts[2]);
    $parts = split("/",$_POST['enddate']);
